...
export default function TermsPage() {
  return <LegalShell title="Condiciones de uso" intro="Reglas básicas para participar de forma segura en la comunidad CromoNexo.">
    ...
    <section><h2>3. Intercambios y compraventas</h2><p>Cada acuerdo se celebra entre comprador y vendedor o entre quienes intercambian. Antes de cerrar un trato, revisa el estado del cromo, precio, entrega y gastos. CromoNexo no procesa el pago ni el envío durante la beta. La aportación de fotografías y un código temporal acredita únicamente que se presentaron imágenes vinculadas al anuncio; no constituye una certificación oficial de autenticidad, estado o valor.</p></section>
