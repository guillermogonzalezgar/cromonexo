...
type S = { id:string; number:string; name:string|null; team:string;category?:string|null;collection?:Relation<Collection> };
...
export default function MarketClient({ userId, listings, availableStickers }:{ userId:string; listings:L[]; availableStickers:S[] }) {
  ...
  return <>
    ...
    <aside className="mb-5 rounded-2xl border border-[#9ac328]/35 bg-[#f5fbdc] p-4 text-sm text-[#294b37]"><strong>El mercado abre el 1 de octubre.</strong> Ya puedes subir tus cromos. Todas las compras se pagarán dentro de CromoNexo: hasta 5 € se enviarán por carta con sello, por encima de 5 € mediante Correos con seguimiento y siempre podrá elegirse entrega en mano. <Link href="/condiciones" className="font-black underline">Ver condiciones</Link>.</aside>
