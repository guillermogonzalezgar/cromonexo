...
export default function LegalNoticePage() {
  return <LegalShell title="Aviso legal" intro="Información sobre el titular y las reglas generales de acceso a CromoNexo.">
    ...
    <section><h2>2. Objeto</h2><p>CromoNexo es una plataforma tecnológica para que coleccionistas gestionen faltantes y repetidos, encuentren compatibilidades y publiquen anuncios. Desde el 1 de octubre de 2026, las compras habilitadas se pagarán dentro de la plataforma mediante Stripe y ofrecerán las modalidades de entrega indicadas en las condiciones de uso.</p></section>
